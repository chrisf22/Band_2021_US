...
sampledTurbineParamsSummary[, 1] = c("RotorRadius", "HubHeight", "BladeWidth", "WindSpeed", "RotorSpeed", "Pitch_rad", "WFWidth", "Latitude", "Prop_Upwind", "TPower", "JanOp", "FebOp", "MarOp", "AprOp", "MayOp", "JunOp", "JulOp", "AugOp", "SepOp", "OctOp", "NovOp", "DecOp")
sampledTurbineParamsSummary[1, 2:5] = c(mean(sampledTurbine$RotorRadius), sd(sampledTurbine$RotorRadius), median(sampledTurbine$RotorRadius), IQR(sampledTurbine$RotorRadius))
sampledTurbineParamsSummary[2, 2:5] = c(mean(sampledTurbine$HubHeight), sd(sampledTurbine$HubHeight), median(sampledTurbine$HubHeight), IQR(sampledTurbine$HubHeight))
sampledTurbineParamsSummary[3, 2:5] = c(mean(sampledTurbine$BladeWidth), sd(sampledTurbine$BladeWidth), median(sampledTurbine$BladeWidth), IQR(sampledTurbine$BladeWidth))
sampledTurbineParamsSummary[4, 2:5] = c(mean(sampledTurbine$WindSpeed), sd(sampledTurbine$WindSpeed), median(sampledTurbine$WindSpeed), IQR(sampledTurbine$WindSpeed))
sampledTurbineParamsSummary[5, 2:5] = c(mean(sampledTurbine$RotorSpeed), sd(sampledTurbine$RotorSpeed), median(sampledTurbine$RotorSpeed), IQR(sampledTurbine$RotorSpeed))
...
sampledTurbineParamsSummary[7, 2:5] = c(mean(TurbineData$WFWidth), sd(TurbineData$WFWidth), median(TurbineData$WFWidth), IQR(TurbineData$WFWidth))
...
sampledTurbineParamsSummary[10, 2:5] = c(mean(TurbineData$TPower), sd(TurbineData$TPower), median(TurbineData$TPower), IQR(TurbineData$TPower))
...
names(sampledTurbineParamsIters) = c("RotorRadius", "HubHeight", "BladeWidth", "WindSpeed", "RotorSpeed", "Pitch_rad", "WFWidth", "Latitude", "Prop_Upwind", "TPower", "JanOp", "FebOp", "MarOp", "AprOp", "MayOp", "JunOp", "JulOp", "AugOp", "SepOp", "OctOp", "NovOp", "DecOp")
sampledTurbineParamsIters[, 1] = sampledTurbine$RotorRadius
sampledTurbineParamsIters[, 2] = sampledTurbine$HubHeight
sampledTurbineParamsIters[, 3] = sampledTurbine$BladeWidth
sampledTurbineParamsIters[, 4] = sampledTurbine$WindSpeed
sampledTurbineParamsIters[, 5] = sampledTurbine$RotorSpeed
sampledTurbineParamsIters[, 6] = sampledTurbine$Pitch
sampledTurbineParamsIters[, 7] = TurbineData$WFWidth
